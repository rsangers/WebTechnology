...
function GameState(socket) {
  ...
  socket.onmessage=function(event){
    ...
    //If there is no opponent yet, wait for another player
    if(messageIn=="wait"){
      $(".gamearea").css("display","none");
      $(".waitarea").css("display","block");
    }

    //When an opponent has been found, start a game
...
//To check whether a player has four in a row, we check for all directions 
...
// The popup that shows when someone has won the game
